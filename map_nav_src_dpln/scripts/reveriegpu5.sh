...
flag="--root_dir ${DATA_ROOT}
      ...
      --oracle_failure_penalty_weight 4.0
      --early_stop_penalty 5.0"

# train stage 1
accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu5_config.yaml reverie/main_nav_obj.py $flag  \
      --tokenizer bert \
      --bert_ckpt_file ../datasets/REVERIE/exprs_map/pretrain/cmt-vitbase-mlm.mrc.sap.og-init.lxmert-aug.speaker-RAM-l14/ckpts/model_step_20000.pt \
      #--eval_first \
