...
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu0_config.yaml r2r/main_nav.py $flag  \
      #--tokenizer bert \
      #--bert_ckpt_file ../datasets/R4R/exprs_map/pretrain/cmt-vitbase-mlm.mrc.sap-init.lxmert-aug.speaker-RAM-l14/ckpts/model_step_72000.pt \
      #--eval_first \
...
accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu0_config.yaml r2r/main_nav.py $flag  \
      --tokenizer bert \
      --resume_file ../datasets/R4R/exprs_map/finetune/dsrl-vitbase-seed.4-DSRL0/ckpts/latest_dict \
      --resume_optimizer \
      #--eval_first
