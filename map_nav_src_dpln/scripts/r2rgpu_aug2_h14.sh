...
# train stage 1
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu2_config.yaml r2r/main_nav.py $flag  \
      #--tokenizer bert \
      #--bert_ckpt_file ../datasets/R2R/exprs_map/pretrain/cmt-h14-mlm.mrc.sap-init.lxmert-aug.speaker/ckpts/model_step_190000.pt \
...
accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu2_config.yaml r2r/main_nav.py $flag  \
      --tokenizer bert \
      --resume_file ../datasets/R2R/trained_models/best_val_aug_79-31_67 \
      #--eval_first
