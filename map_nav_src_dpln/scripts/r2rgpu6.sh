...
# train stage 1
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu6_config.yaml r2r/main_nav.py $flag  \
      #--tokenizer bert \
...
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu6_config.yaml r2r/main_nav.py $flag  \
      #--tokenizer bert \
      #--resume_file ../datasets/R2R/exprs_map/finetune/dsrl-vitbase-seed.0-DSRL6/ckpts/best_val_unseen \
      #--test --submit
