...
# train stage 1
accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu7_config.yaml soon/main.py $flag  \
      --tokenizer bert \
...
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu7_config.yaml soon/main.py $flag  \
      #--tokenizer bert \
      #--resume_file ../datasets/SOON/exprs_map/finetune/ckpts/best_val_unseen_try \
      #--resume_optimizer \
      #--eval_first
