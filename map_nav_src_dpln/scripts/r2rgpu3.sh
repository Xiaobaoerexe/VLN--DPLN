...
flag="--root_dir ${DATA_ROOT}
      ...
      --use_dual_policy
      --reward_actor_lr 0.175
      --penalty_actor_lr 0.75
...
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu2_config.yaml r2r/main_nav.py $flag  \
      #--tokenizer bert \
      #--resume_file ../datasets/R2R/trained_models/best_val_unseen_ssrl_82_73 \
      #--eval_first
...
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu2_config.yaml r2r/main_nav.py $flag  \
      #--tokenizer bert \
      #--resume_file ../datasets/R2R/exprs_map/finetune/dsrl-vitbase-seed.0-DSRL3/ckpts/best_val_unseen \
      #--test --submit
