...
outdir=${DATA_ROOT}/SOON/exprs_map/finetune/fianltest
...
flag="--root_dir ${DATA_ROOT}
      ...
      --use_dynamic_ml_weight 2000
      --use_dynamic_rl_weight 1500
...
# train stage 1
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu3_config.yaml soon/main.py $flag  \
      #--tokenizer bert \
...
accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu3_config.yaml soon/main.py $flag  \
      --tokenizer bert \
      --resume_file ../datasets/SOON/trained_models/best_val_unseen_house_37-79 \
      --test --submit
