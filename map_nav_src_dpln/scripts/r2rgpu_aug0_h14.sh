...
# train stage 1
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu0_config.yaml r2r/main_nav.py $flag  \
      #--tokenizer bert \
      #--bert_ckpt_file ../datasets/R2R/exprs_map/pretrain/cmt-h14-mlm.mrc.sap-init.lxmert-aug.speaker/ckpts/model_step_186000.pt \
...
accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu0_config.yaml r2r/main_nav.py $flag  \
      --tokenizer bert \
      --resume_file ../datasets/R2R/trained_models/best_val_ang_78-76_67 \
      #--eval_first
