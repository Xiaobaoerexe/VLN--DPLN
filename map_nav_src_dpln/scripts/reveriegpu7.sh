...
# train stage 1
accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu7_config.yaml reverie/main_nav_obj.py $flag  \
      --tokenizer bert \
      --bert_ckpt_file ../datasets/REVERIE/exprs_map/pretrain/cmt-vitbase-mlm.mrc.sap.og-init.lxmert-aug.speaker-RAM-l14/ckpts/model_step_18000.pt \
      #--eval_first \
