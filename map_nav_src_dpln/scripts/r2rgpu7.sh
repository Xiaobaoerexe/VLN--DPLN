...
accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu7_config.yaml r2r/main_nav.py $flag  \
      --tokenizer bert \
      --resume_file ../datasets/R2R/trained_models/latest_dict_74-63_60 \
      #--eval_first
...
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu7_config.yaml r2r/main_nav.py $flag  \
      #--tokenizer bert \
      #--resume_file ../datasets/R2R/exprs_map/finetune/dsrl-vitbase-seed.0-DSRL7/ckpts/best_val_unseen \
      #--test --submit
