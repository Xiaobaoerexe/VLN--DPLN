...
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu2_config.yaml r2r/main_nav.py $flag  \
      #--tokenizer bert \
      #--resume_file ../datasets/R2R/trained_models/best_val_unseen_dsrl_80_73 \
      #--eval_first
...
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu2_config.yaml r2r/main_nav.py $flag  \
      #--tokenizer bert \
      #--resume_file ../datasets/R2R/exprs_map/finetune/dsrl-vitbase-seed.0-DSRL2/ckpts/best_val_unseen \
      #--test --submit
