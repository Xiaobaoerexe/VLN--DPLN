...
accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu0_config.yaml r2r/main_nav.py $flag  \
      --tokenizer bert \
      --bert_ckpt_file ../datasets/RxR/exprs_map/pretrain/cmt-vitbase-mlm.mrc.sap-init.lxmert-aug.speaker-RAM-l14/ckpts/model_step_26000.pt \
      #--eval_first \
...
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu0_config.yaml r2r/main_nav.py $flag  \
      #--tokenizer bert \
      #--resume_file ../datasets/RxR/trained_models/best_val_unseen_try \
      #--eval_first
