...
flag="--root_dir ${DATA_ROOT}
      ...
      --use_dual_policy
      --reward_actor_lr 0.15
      --penalty_actor_lr 0.7
      --use_dynamic_ml_weight 6000
...
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu5_config.yaml r2r/main_nav.py $flag  \
      #--tokenizer bert \
      #--resume_file ../datasets/R2R/exprs_map/finetune/dsrl-vitbase-seed.0-DSRL5/ckpts/best_val_unseen \
      #--test --submit
