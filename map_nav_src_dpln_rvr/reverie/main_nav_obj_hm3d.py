...
def build_dataset(args, rank=0):
    ...
    obj_db_aug = ObjectFeatureDB("../datasets/REVERIE/features/obj_fts", args.obj_feat_size, im_width=224, im_height=224)
    ...
    if not args.test and args.aug is not None:
        ...
        aug_env = HM3DReverieObjectNavBatch(
            feat_db, obj_db_aug, [aug_instr_file], args.connectivity_dir,
