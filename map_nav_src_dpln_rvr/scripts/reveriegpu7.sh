...
# train stage 1
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu7_config.yaml reverie/main_nav_obj_hm3d.py $flag \
      #--tokenizer bert \
      #--bert_ckpt_file ../datasets/REVERIE/exprs_map/pretrain/hm3d_rvr/ckpts/model_step_84000.pt \
