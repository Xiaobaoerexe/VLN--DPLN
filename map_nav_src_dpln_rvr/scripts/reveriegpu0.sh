...
flag="--root_dir ${DATA_ROOT}
      ...
      --use_dynamic_ml_weight 30000
      --use_dynamic_rl_weight 50000
...
# train stage 1
accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu0_config.yaml reverie/main_nav_obj_hm3d.py $flag \
      --tokenizer bert \
      --bert_ckpt_file ../datasets/REVERIE/exprs_map/pretrain/hm3d_rvr/ckpts/model_step_50000.pt \
