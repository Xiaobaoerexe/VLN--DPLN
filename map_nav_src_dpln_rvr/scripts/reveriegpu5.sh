...
# train stage 1
#accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu5_config.yaml reverie/main_nav_obj_hm3d.py $flag \
      #--tokenizer bert \
      #--bert_ckpt_file ../datasets/REVERIE/exprs_map/pretrain/hm3d_rvr/ckpts/model_step_192000.pt \
...
accelerate launch --config_file ~/.cache/huggingface/accelerate/gpu5_config.yaml reverie/main_nav_obj_hm3d.py $flag \
      --tokenizer bert \
      --resume_file ../datasets/REVERIE/trained_models/best_val_aug_53-22_40 \
      #--eval_first
